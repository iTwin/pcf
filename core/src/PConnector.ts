...
export abstract class PConnector {
  ...
  /**
   * Trim the iModel tree rooted at the given branch, the ECInstanceId of an element or model. This
   * method deletes all elements and models that have not been seen by the synchronizer, and whose
   * children have not been seen.
   *
